...
//
/**\class ShashlikAnalyzer ShashlikAnalyzer.cc ShashlikAnalyzer/ShashlikAnalyzer/plugins/ShashlikAnalyzer.cc

 Description: [one line class summary]
    started from RecoEgamma/Examples/src/GsfElectronMCAnalyzer.cc
...
void ShashlikAnalyzer::beginJob(){
...
ShashlikAnalyzer::endJob(){
  ...
  std::cout << "[ShashlikAnalyzer] efficiency calculation " << std::endl;
  // efficiency vs eta
  ...
  std::cout << "[ShashlikAnalyzer] q-misid calculation " << std::endl;
  // misid vs eta
  ...
  std::cout << "[ShashlikAnalyzer] all reco electrons " << std::endl;
